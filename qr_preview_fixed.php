 ...
 * Works with actual registration table structure (student_id)
 */
...
try {
    ...
    // Fetch registration details using correct table structure
    $stmt = $pdo->prepare("
        SELECT 
    ...
    $is_owner = ($current_user_id == $registration['student_id']);
...
<body>
    <div class="container">
        ...
        <div class="event-info">
            ...
            <div class="info-row">
                ...
                <?php echo htmlspecialchars($registration['student_email']); ?>
            </div>
            ...
            <div class="info-row">
                ...
                <?php echo date('F j, Y g:i A', strtotime($registration['registered_on'])); ?>
            </div>
            
            <?php if ($registration['approved_at']): ?>
            <div class="info-row">
                <span class="label">Approved:</span>
                <?php echo date('F j, Y g:i A', strtotime($registration['approved_at'])); ?>
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="qr-section">
            ...
            <div style="margin-top: 20px;">
                ...
                <a href="download_qr_fixed.php?registration_id=<?php echo $registration_id; ?>" 
    ...
    function generateQR() {
        ...
        img.src = 'download_qr_fixed.php?registration_id=<?php echo $registration_id; ?>&preview=1';
        img.style.maxWidth = '100%';
        img.style.height = 'auto';
    }
    
    // Auto-generate QR code if registration has approved/confirmed status
    <?php if (in_array($registration['status'], ['confirmed', 'approved'])): ?>
